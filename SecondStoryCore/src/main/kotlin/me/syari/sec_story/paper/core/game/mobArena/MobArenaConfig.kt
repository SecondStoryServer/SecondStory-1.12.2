...
import me.syari.sec_story.paper.core.game.mobArena.MobArena.setArenas
...
import me.syari.sec_story.paper.core.game.mobArena.wave.MobArenaWaveAll
import me.syari.sec_story.paper.core.game.mobArena.wave.boss.MobArenaBoss
import me.syari.sec_story.paper.core.game.mobArena.wave.boss.MobArenaBossEquip
import me.syari.sec_story.paper.core.game.mobArena.wave.boss.MobArenaCustomBoss
import me.syari.sec_story.paper.core.game.mobArena.wave.boss.MobArenaMythicMobsBoss
import me.syari.sec_story.paper.core.game.mobArena.wave.boss.skill.*
import me.syari.sec_story.paper.core.game.mobArena.wave.mob.MobArenaMob
import me.syari.sec_story.paper.core.game.mobArena.wave.mob.MobArenaMythicMobsMob
import me.syari.sec_story.paper.core.game.mobArena.wave.mob.MobArenaVanillaMob
...
object MobArenaConfig {
    fun CommandSender.loadMobArena() {
        ...
        getConfigDir(plugin, "MobArena").forEach { (yml, config) ->
                ...
                if(waveNums.isNotEmpty()) {
                    ...
                    if(waveNums.first() == 1) {
                        ...
                        waveNums.forEach { num ->
                                ...
                                if(type != null) {
                                    ...
                                    getStringList("wave.$num.boss.skill")?.forEach { rawSkill ->
                                        ...
                                        when(splitSkill[0].toLowerCase()) {
                                            ...
                                            "push" -> skills.add(
                                                MobArenaBossSkillPush(splitSkill.getOrNull(1)?.toDoubleOrNull() ?: 5.0)
                                            )
                                            "fire" -> skills.add(
                                                MobArenaBossSkillFire(
                                                    splitSkill.getOrNull(1)?.toIntOrNull() ?: 20,
                                                    splitSkill.getOrNull(2)?.toDoubleOrNull() ?: 5.0
                                                )
                                            )
                                            "freeze" -> skills.add(
                                                MobArenaBossSkillFreeze(
                                                    splitSkill.getOrNull(1)?.toIntOrNull() ?: 20,
                                                    splitSkill.getOrNull(2)?.toDoubleOrNull() ?: 5.0
                                                )
                                            )
                            ...
                            reward = getConfigContentsFromList("wave.$num.boss.reward", false)
                            preNum = num
                        }
                        waveList.add(
                            MobArenaWave(
                                arena, preNum..preNum, health, all, spawnOverride, true, mobs, boss, upgrade, reward
                            )
                        )
