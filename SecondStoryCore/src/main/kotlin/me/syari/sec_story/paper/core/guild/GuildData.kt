...
import me.syari.sec_story.paper.core.guild.Guild.guildFromName
import me.syari.sec_story.paper.core.guild.Guild.guildPlayer
import me.syari.sec_story.paper.core.guild.Guild.guilds
import me.syari.sec_story.paper.core.guild.altar.AltarData
import me.syari.sec_story.paper.core.guild.altar.GuildAltar.getDataFromExp
import me.syari.sec_story.paper.core.guild.area.GuildArea.sellPrice
import me.syari.sec_story.paper.core.guild.area.GuildArea.setGuild
import me.syari.sec_story.paper.core.guild.quest.GuildQuest.getDailyQuest
import me.syari.sec_story.paper.core.guild.quest.GuildQuest.getWeeklyQuest
import me.syari.sec_story.paper.core.guild.quest.QuestGuildData
import me.syari.sec_story.paper.core.guild.war.War
import me.syari.sec_story.paper.core.guild.war.WarGuild
...
class GuildData(val id: UUID) {
    ...
    var leader: OfflinePlayer?
        set(value) {
            ...
            if(value != null) {
                sql {
                    executeUpdate(
                        "UPDATE Story.Guild SET Leader = '${value.name}', LeaderUUID = '${value.uniqueId}' WHERE GuildID = '$id';"
                    )
                }
            }
        }
    ...
    fun removeArea(rem: Chunk) {
        ...
        sql {
            executeUpdate(
                "DELETE FROM Story.GuildArea WHERE World = '${rem.world.name}' AND X = ${rem.x} AND Z = ${rem.z};"
            )
        }
        rawAreas = area
    }
