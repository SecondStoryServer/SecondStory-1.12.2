package me.syari.sec_story.paper.core.world
...
import me.syari.sec_story.paper.core.hook.MultiverseCore.firstSpawnWorld
...
object AllowWorld: EventInit {
    fun CommandSender.loadAllow() {
        clearAllow()
        config(plugin, "allow.yml", false) {
