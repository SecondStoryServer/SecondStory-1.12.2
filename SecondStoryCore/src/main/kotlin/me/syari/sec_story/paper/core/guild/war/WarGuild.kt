...
import me.syari.sec_story.paper.core.guild.war.GuildWar.setKit
...
class WarGuild(val guild: GuildData, val team: WarTeam) {
    ...
    val member get() = warMember

    val livingMember get() = warMember.filter { f -> ! f.isDead(guild.war?.life ?: 1) }
