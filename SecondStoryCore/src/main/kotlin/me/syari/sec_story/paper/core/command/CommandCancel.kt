...
import me.syari.sec_story.paper.core.donate.Donate.donateCmd
import me.syari.sec_story.paper.core.rank.Ranks.rankCmd
...
object CommandCancel: FunctionInit, EventInit {
    ...
    fun Player.isAllowCmd(cmd: String): Boolean {
