                ...
                when(args.whenIndex(0)) {
                    ...
                    "skill" -> {
                        if(pet.skilltree != null) {
                            runCommand(sender, "pskill")
                        } else {
                            runCommand(sender, "pcst")
                        }
                    }
                    "inv" -> {
                        runCommand(sender, "petinventory")
                    }
                    "pick" -> {
                        runCommand(sender, "petpickup")
                    }
                    "target" -> {
                        runCommand(sender, "petbehavior")
                    }
                    "beacon" -> {
                        runCommand(sender, "petbeacon")
                    }
                    "bye" -> {
                        runCommand(sender, "petrelease")
                    }
                    else -> {
                        sender.send(
                            """
