...
import me.syari.sec_story.config.content.ConfigExp
import me.syari.sec_story.config.content.ConfigItemStack
import me.syari.sec_story.config.content.ConfigMoneyEme
import me.syari.sec_story.game.kit.GameKit.loadKit
import me.syari.sec_story.game.mobArena.MobArenaConfig.loadMobArena
import me.syari.sec_story.game.summonArena.MobPoint
import me.syari.sec_story.game.summonArena.SummonArena
import me.syari.sec_story.game.summonArena.SummonArenaData
import me.syari.sec_story.game.summonArena.SummonArenaMob
import me.syari.sec_story.guild.GuildConfig.loadGuild
import me.syari.sec_story.hook.MythicMobs.getItemFromMythicMobs
import me.syari.sec_story.hook.MythicMobs.getMythicMobs
import me.syari.sec_story.item.LoginReward
import me.syari.sec_story.item.Vote
import me.syari.sec_story.item.code.ItemCodeConfig.loadItemCode
...
import me.syari.sec_story.rank.Rank
import me.syari.sec_story.rank.Ranks
import me.syari.sec_story.rank.req.*
import me.syari.sec_story.rpg.Quest
import me.syari.sec_story.rpg.Quests
import me.syari.sec_story.rpg.RPG
import me.syari.sec_story.server.CommandBlock.loadCommand
import me.syari.sec_story.server.IPBlackList
import me.syari.sec_story.server.Repair.RepairItem
import me.syari.sec_story.server.Server
import me.syari.sec_story.server.Server.textureURL
import me.syari.sec_story.shop.ShopConfig.isLoadedSell
import me.syari.sec_story.shop.ShopConfig.loadShop
import me.syari.sec_story.tour.TourConfig.loadHelp
import me.syari.sec_story.world.AllowWorld.loadAllow
import me.syari.sec_story.world.portal.Portal.loadPortal
...
object Config {
    ...
    fun CommandSender.loadConfig(){
        config("config.yml", false) {
            ...
            RepairItem = getItemFromMythicMobs(getString("Repair", "RepairItem"), 1)
                    ...
                    config("sell.yml") {
                        ...
                        e.drops.forEach { f ->
                            ...
                            if (!isLoadedSell(itemID)) {
                                val item = getItemFromMythicMobs(itemID, 1)
    ...
    fun CommandSender.loadDonate(){
        Donate.ranks.clear()
        config("donate.yml", false) {
            ...
            getSection("")?.forEach { f ->
                ...
                if (price != null) {
                    ...
                    Donate.ranks.add(Donate.DonateRank(price, cmd, perm))
                }
            }
        }
    }
