...
import me.syari.sec_story.game.summonArena.SummonArena.getMob
import me.syari.sec_story.game.summonArena.SummonArena.selectMob
...
data class SummonArenaMob(
    ...
    fun getIcon(viewer: Player): CustomItemStack {
        val icon = icon.copy()
        icon.display  = "&f$name"
        icon.lore = getInfo(viewer)
        icon.amount = difficulty
        return icon
    }
