...
data class MobArenaBossEquip(
    val main: CustomItemStack?,
    val sub: CustomItemStack?,
    val helmet: CustomItemStack?,
    val chestPlate: CustomItemStack?,
    val leggings: CustomItemStack?,
    val boots: CustomItemStack?
){
