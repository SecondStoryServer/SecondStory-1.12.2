        ...
        createCmd("perm",
            ...
            when(args.whenIndex(0)){
                ...
                "reload" -> {
                    ...
                    if(name != null){
                        val p = plugin.server.getPlayer(name) ?: return@createCmd sender.send("&b[Perm] &cプレイヤーが見つかりませんでした")
                        p.loadPerm()
